...
public class ChaptersAdapter extends BaseAdapter {
    ...
    public ChaptersAdapter(int numOfSets) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ChaptersActivity.selected_chapter_index = position;
        ...
        ((TextView) view.findViewById(R.id.setNo_tv)).setText(ChaptersList.get(position));
